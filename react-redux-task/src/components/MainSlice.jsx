...
let data = [
  {
    ...
    thumbnail:
      "https://media.croma.com/image/upload/v1708672547/Croma%20Assets/Communication/Mobiles/Images/261931_0_ztucar.png",
    images: [
  ...
  },
  {
    ...
    category: "smartphones",
    thumbnail:
      "https://th.bing.com/th/id/OIP.4tZ2zpMgkLIGAvDBNeoajgHaHa?w=181&h=181&c=7&r=0&o=5&dpr=1.5&pid=1.7",
    images: [
  ...
  },
  {
    ...
    category: "smartphones",
    thumbnail:
      "https://th.bing.com/th/id/OIP.iSljZvfeu0Bd4UKbye5AMgHaHa?w=224&h=220&c=7&r=0&o=5&dpr=1.5&pid=1.7",
    images: [
...
const MainSlice = createSlice({
  ...
  reducers: {
    ...
    addCartItems: (state, action) => {
      const res = state.allItems.filter((ele) => {
        return ele.id == action.payload;
      });
      state.cartItems = [...state.cartItems, ...res];
    },

    removeCartItems: (state, action) => {
      const res = state.cartItems.filter((ele) => {
        return ele.id !== action.payload;
      });
      state.cartItems = [...res];
    },
...
export const { setAllItems, addCartItems, removeCartItems } = MainSlice.actions;
